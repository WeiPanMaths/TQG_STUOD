...
class data_assimilation_workspace(Workspace):
    def __init__(self, workspace_dir):
        ...
        self.test_files_dir       = self.sub_dir('TestFiles-fres-obs')
        ...
        self.diagnostic_dir      = self.sub_dir('Diagnostics-fres-obs')
        self.zetas_dir            = self.sub_dir('ParamFiles')

    def get_zetas_dir(self):
        return self.zetas_dir
