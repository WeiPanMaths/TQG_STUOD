...
# Author Wei Pan
# 
# STQG solver with Euler dynamics for bathymetry
#
...
import euler.particle as salt_euler


class STQGSolverEulerBathymetry(object):
    ...
    def __init__(self, tqg_params): 
        ...
        self.solver_name = 'TQG Euler solver'
    ...
    def solve(self, dumpfreq, output_name, data_output_name, comm_manager, do_save_data=False, do_save_visual=True, do_save_spectrum=False, res=0, zetas_file_name=None, xi_scaling=1, bathymetry_xi=False, **kwargs):
        ...
        while t < (T - Dt / 2):
            ...
            if self.solver_name == 'TQG Euler solver':
                euler_solver.pdesolver(euler_solver.initial_cond, output_name='', chkpt_flag=False)
                euler_solver.psi_solve_given_q(euler_solver.initial_cond)
                self.bathymetry.assign(euler_solver.psi0)
