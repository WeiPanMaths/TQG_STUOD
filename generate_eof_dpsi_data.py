...
if __name__ == "__main__":
    ...
    #input_fname =       "/home/wpan1/Data2/PythonProjects/DataAssimilationAngryDolphin/PDESolution-no-bathymetry-perturbation"
    #input_fname = "/home/wpan1/Data/PythonProjects/AngryDolphin"
    fname = "/home/wpan1/Data2/PythonProjects/DataAssimilationAngryDolphin"
    ...
    for f_index in range(0, 1500, 20):  
...
## below was used for looking at the statistics
if 0:
            psi_t_np = Function(solver.psi0.function_space(), name="Streamfunction")
            psi_t_n  = Function(solver.psi0.function_space())
            rpsi_t_np = Function(solver_reg.psi0.function_space())
            rpsi_t_n  = Function(solver_reg.psi0.function_space())
            ...
            if procno == 0 and write_visual:
                output_file.write(psi_t_np, rpsi_reg_t_np , time=f_index-2775+0)
